...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.bConvert.setGeometry(QtCore.QRect(200, 330, 341, 34))
        ...
        self.bOpenOutputFolder.setGeometry(QtCore.QRect(550, 330, 241, 34))
        ...
        self.qleApiKey.setGeometry(QtCore.QRect(380, 290, 341, 34))
        self.qleApiKey.setObjectName("qleApiKey")
        
        self.labelApiKey = QtWidgets.QLabel(self.centralwidget)
        self.labelApiKey.setGeometry(QtCore.QRect(200, 290, 341, 34))
    ...
    def retranslateUi(self, window):
        ...
        self.labelSelectLangTranslate.setText(_translate("window", "Audio Language Translate:"))
        self.labelApiKey.setText(_translate("window", "Api Key required for translate:"))
